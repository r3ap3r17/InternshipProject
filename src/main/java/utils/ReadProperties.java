...
public class ReadProperties {
    ...
    private static String readConfigValues(String propertyKey) {
        ...
        try {
            InputStream propertyFile = Files.newInputStream(Paths.get("C:/Users/Veljko Blagojevic/IdeaProjects/InternshipProject/src/main/java/data/Configurations.properties"));
